...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        public void DeleteWorkerByLastName(string CurrentName)
        {
            this.Workers.RemoveAll(e => e.LastName == CurrentName);
        }

        public void DeleteWorkerByAge(int MaxAge)
        {
            this.Workers.RemoveAll(e => e.Age > MaxAge);
        }
    }
}
